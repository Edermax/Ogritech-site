-- A Diniz cobra a entrega pela distância de ida: km x R$ 1,25.
-- As faixas inteiras mantêm o cálculo simples, rastreável e validado pelo servidor.
do $$
declare
...
begin
  ...
  select target_menu.barbershop_id,
         target_menu.id,
         format('diniz-auto-%skm', kilometer),
         format('Entrega automática · até %s km', kilometer),
         round(kilometer * 1.25, 2),
         0,
         null,
         true
